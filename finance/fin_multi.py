...
# Load data
df = pd.read_csv('./financial_data/ETHUSD.csv')
...
# Calculate binary sequence
binary_sequence = [1 if x <= -80 else 0 for x in df['W%R']]
...
# Plot closing prices and Williams %R indicator
...
# Set title and labels
ax1.set_title('ETH-USD Closing Prices and Williams %R in 2022', fontsize=16)
